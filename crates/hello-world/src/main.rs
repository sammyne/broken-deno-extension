...
async fn main() -> anyhow::Result<()> {
    ...
    let mut worker =
        MainWorker::bootstrap_from_options(&module_url, service_options, worker_options);
    worker
...
pub fn new_worker_service_options()
...
pub fn resolve_path(p: &Path) -> anyhow::Result<ModuleSpecifier> {
